...
<?php
	$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE categorie='baie' ORDER BY id ASC");
	if (!empty($product_array)) { 
		foreach($product_array as $key=>$value){
	?>
	
	<table>
	<form method="post" action="baie.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
