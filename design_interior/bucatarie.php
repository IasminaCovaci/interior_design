...
<body>
	...
	<nav class="navbar navbar-expand-md tm-main-nav-container">
					<nav id="mainav">
				   <ul class="clear">
					<li class="active"><a href="home.html">Acasă</a></li>
  ...
  <div class="container">
     <div class="row product_style_3" ">
	  ...
	  <?php
	$product_array = $db_handle->runQuery("SELECT * FROM produse WHERE categorie='bucatarie' ORDER BY id ASC");
	if (!empty($product_array)) { 
		foreach($product_array as $key=>$value){
	?>
	
	<table>
	<form method="post" action="bucatarie.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
